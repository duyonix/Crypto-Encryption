# CBC
# encrypt
$openssl enc  -aes-128-cbc  -e -in ciphertext.txt -out cbc_cipher.bin \
...
# CFB
#encrypt
$openssl enc  -aes-128-cfb  -e -in ciphertext.txt -out cfb_cipher.bin \
-K 00112233445566778889aabbccddeeff \
-iv 0102030405060708
...
# OFB
#encrypt
$openssl enc  -aes-128-ofb  -e -in ciphertext.txt -out ofb_cipher.bin \
-K 00112233445566778889aabbccddeeff \
-iv 0102030405060708
