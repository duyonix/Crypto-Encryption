...
# ECB
openssl enc  -aes-128-ecb  -e -in test.txt -out output.bin -K 00112233445566778889aabbccddeeff -iv 0102030405060708
ls -ld output.bin # 16
...
# CFB
openssl enc  -aes-128-cfb  -e -in test.txt -out output.bin -K 00112233445566778889aabbccddeeff -iv 0102030405060708 
ls -ld output.bin # 11

# OFB
openssl enc  -aes-128-ofb  -e -in test.txt -out output.bin -K 00112233445566778889aabbccddeeff -iv 0102030405060708
ls -ld output.bin # 11
